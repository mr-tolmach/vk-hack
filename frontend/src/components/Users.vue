  ...
  methods: {
    filterSugested (people) {
      people.filter(e => {
        ...
        console.log('info', this.api_result)
        console.log('city_title', this.api_result.city.title)
        let onlymyCity = !this.filters.onlymyCity || (e.city_name === this.api_result.city.title && this.filters.onlymyCity)
        console.log(isMale)
